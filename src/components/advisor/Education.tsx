          ...
          {isNewCert && (
            <AnimatedEntry animation="scale-in">
              ...
              >
                <div className="space-y-3">
                  <div className="space-y-2">
                    <Label htmlFor="new-cert-name" className="text-sm">Certification Name</Label>
                    <Input
                      id="new-cert-name"
                      name="name"
                      value={editCertForm?.name || ""}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="new-cert-issuer" className="text-sm">Issuing Organization</Label>
                    <Input
                      id="new-cert-issuer"
                      name="issuer"
                      value={editCertForm?.issuer || ""}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="new-cert-year" className="text-sm">Year</Label>
                    <Input
                      id="new-cert-year"
                      name="year"
                      value={editCertForm?.year || ""}
